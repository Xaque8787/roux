...
def create_default_categories(db: Session):
    ...
    default_categories = [
        ...
        ("Dressings & Sauces", "ingredient", "fa-bottle-droplet", "#28a745"),
        ...
        ("Produce Prep", "batch", "fa-leaf", "#ffc107"),
        ("Dairy Prep", "batch", "fa-cheese", "#ffc107"),
        ("Protein Prep", "batch", "fa-drumstick-bite", "#ffc107"),
        ("Frozen Items", "batch", "fa-snowflake", "#ffc107"),
        ...
        ("Produce Prep", "inventory", "fa-leaf", "#6c757d"),
        ("Dairy Prep", "inventory", "fa-cheese", "#6c757d"),
        ("Protein Prep", "inventory", "fa-drumstick-bite", "#6c757d"),
        ("Frozen Items", "inventory", "fa-snowflake", "#6c757d"),
        ...
        ("Soup Dishes", "dish", "fa-mug-hot", "#0d6efd"),
        ("Desserts", "dish", "fa-ice-cream", "#0d6efd"),
        ("Beverages", "dish", "fa-wine-glass", "#0d6efd"),
        ("Daily Specials", "dish", "fa-star", "#0d6efd"),
    ]
